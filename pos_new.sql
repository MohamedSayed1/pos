...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 17, 2021 at 02:21 PM
...
--
ALTER TABLE `supplier_account`
  ADD CONSTRAINT `purchases_id` FOREIGN KEY (`purch_id`) REFERENCES `purchases` (`purchases_id`),
